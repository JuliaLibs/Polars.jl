...
julia_module!{
  ...
  in polars_value_type_t fn from_name_and_kwargs(name: CCallRef<Symbol>, kwargs: CCallRef<NamedTuple<'_, 'static>>) -> JlrsResult<ValueTypeRet> as polars_value_type_from_name_and_kwargs;
